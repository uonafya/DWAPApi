...
class DataClientViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        url = f"https://hiskenya.org/api/analytics.json?dimension=ou:LEVEL-3;fVra3Pwta0Q&dimension=dx:f9vesk5d4IY;uSxBUWnagGg;qSgLzXh46n9;ETX9cUWF43c;mQz4DhBSv9V;LQpQQP3KnU1;oZc8MNc0nLZ;nwXS5vxrrr7;hn3aChn4sVx;AfHArvGun12;hHLR1HP8xzI;lJpaBye9B0H;WNFWVHMqPv9;ckPCoAwmWmT;vkOYqEesPAi;UMyB7dSIdz1;HAumxpKBaoK;Jn6ATTfXp02;RY1js5pK2Ep&dimension=pe:202402&outputIdScheme=UID"
        client = PMTCTDataClient(url,params=params, credentials=credentials)
        data = client.pull_data()
        analytic_data = dataAnalytics(data)
