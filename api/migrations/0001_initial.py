...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, default='Mulele', max_length=255, null=True)),
                ('uid', models.CharField(blank=True, default='xxxxxxxxx', max_length=255, null=True)),
                ('mfl_code', models.CharField(blank=True, default='0000', max_length=255, null=True)),
                ('level', models.CharField(blank=True, default=5, max_length=5, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facilities', models.ManyToManyField(blank=True, null=True, to='api.facilities')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('wards', models.ManyToManyField(blank=True, null=True, to='api.ward')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('subcounties', models.ManyToManyField(blank=True, null=True, to='api.subcounties')),
            ],
            options={
